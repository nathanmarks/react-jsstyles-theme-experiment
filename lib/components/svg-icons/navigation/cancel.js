...
(function () {
  ...
  __REACT_HOT_LOADER__.register(NavigationCancel, 'NavigationCancel', 'src/components/svg-icons/navigation/cancel.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/svg-icons/navigation/cancel.js');
})();
