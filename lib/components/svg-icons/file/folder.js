...
(function () {
  ...
  __REACT_HOT_LOADER__.register(FileFolder, 'FileFolder', 'src/components/svg-icons/file/folder.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/svg-icons/file/folder.js');
})();
