...
(function () {
  ...
  __REACT_HOT_LOADER__.register(ActionFace, 'ActionFace', 'src/components/svg-icons/action/face.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/svg-icons/action/face.js');
})();
