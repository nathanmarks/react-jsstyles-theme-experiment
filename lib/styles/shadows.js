...
(function () {
  ...
  __REACT_HOT_LOADER__.register(shadowKeyUmbraOpacity, 'shadowKeyUmbraOpacity', 'src/styles/shadows.js');

  __REACT_HOT_LOADER__.register(shadowKeyPenumbraOpacity, 'shadowKeyPenumbraOpacity', 'src/styles/shadows.js');

  __REACT_HOT_LOADER__.register(shadowAmbientShadowOpacity, 'shadowAmbientShadowOpacity', 'src/styles/shadows.js');

  __REACT_HOT_LOADER__.register(createShadow, 'createShadow', 'src/styles/shadows.js');

  __REACT_HOT_LOADER__.register(shadows, 'shadows', 'src/styles/shadows.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/styles/shadows.js');
})();
